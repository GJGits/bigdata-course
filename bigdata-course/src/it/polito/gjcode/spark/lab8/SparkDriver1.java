...
public class SparkDriver1 {
	...
	public static void main(String[] args) {
		...
		Dataset<RegisterCount> registersDataset = session.read().format("csv").option("delimiter", "\\t")
		...
		// filteredRegister.repartition(1).write().format("csv").option("header",
