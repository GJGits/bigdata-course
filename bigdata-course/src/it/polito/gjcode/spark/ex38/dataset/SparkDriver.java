...
public class SparkDriver {
	...
	public static void main(String[] args) {
		...
		// Filter the content of dsReadings. Select only the lines with PM10>50 (i.e.,
		// _c2>50)
		...
		Dataset<SensorCount> countPerSensorDS = rgdReadingsPerSensor.count().withColumnRenamed("_c0", "sensorid")
