package it.polito.gjcode.spark.ex38.sql;
...
public class SparkDriver {
	...
	public static void main(String[] args) {
		...
		// PM10 value greater than the critical threshold 50 and the number of critival
		// readings
		// PM10 is column _c2
		...
		Dataset<SensorCount> maxValuePerSensorDS = ss.sql(
				"SELECT _c0 as sensorid, count(*) as count FROM readings WHERE _c2>50 GROUP BY _c0 HAVING count(*)>=2")
