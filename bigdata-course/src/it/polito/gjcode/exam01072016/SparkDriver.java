...
public class SparkDriver {
	...
	public static void main(String[] args) {
		...
		// Compute the difference (apply subtract) between the ids of the expensive
		// books and
		// those of the bought books. Only the ids of the expensive never-sold books are
		// returned
		...
		// complex counter containing two integer values: num. purchases and num. cheap
		// purchases
