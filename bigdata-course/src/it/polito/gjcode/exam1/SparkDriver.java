...
public class SparkDriver {
	...
	public static void main(String[] args) {
		...
		// It is used to associated each user with the genres of the movies he/she
		// watched
		...
		// For each user, the filter compares the list of watched genres and the list of
		// liked genres
		...
		JavaPairRDD<String, Tuple2<Iterable<String>, Iterable<String>>> misleadingUsersListsRDD = userWatchedLikedGenres
				.filter(new CheckMisleading(threshold));
